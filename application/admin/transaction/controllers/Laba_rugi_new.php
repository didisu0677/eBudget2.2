...
class Laba_rugi_new extends BE_Controller {
    ...
    function index($p1="") { 
     ...
     function data ($anggaran1="", $cabang=""){
        ...
        $select_labarugi = ',c.bulan_1,c.bulan_2,c.bulan_3,c.bulan_4,c.bulan_5,c.bulan_6,c.bulan_7,c.bulan_8,c.bulan_9,c.bulan_10,c.bulan_11,c.bulan_12,ifnull(c.changed,"[]") as changed';
        ...
        $coa = get_data('tbl_m_coa a',[
            ...
            'join' => [
                ...
                "tbl_labarugi c on c.glwnco = a.glwnco and kode_cabang = '$cabang' and kode_anggaran = '$anggaran->kode_anggaran' type left"
            ]
        ])->result();
