...
class Tabungan extends BE_Controller {
   ...
   ///     debug('x');die;
    ...
    //    debug($data_view['jml_plantab']);die;
        ...
        $view_segment  = $this->rincian_tabungan($anggaran,$cab);
    ...
    private function rincian_tabungan($anggaran,$cabang){
        $a = get_access('tabungan');
        $access_edit = false;
        if($a['access_edit']):
            $access_edit = true;
        endif;
    ...
    function data4($kode_anggaran="", $kode_cabang=""){
        ...
        $view_segment = $this->jum_korporasi_retail($anggaran,$cab);
    ...
    private function jum_korporasi_retail($anggaran,$cabang){
        $a = get_access('tabungan');
        $access_edit = false;
        if($a['access_edit']):
            $access_edit = true;
