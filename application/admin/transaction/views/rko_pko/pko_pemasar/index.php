	...
	$item .= '<div class="card mb-2">
				...
				<div class="table-responsive">
				    <table class="table table-bordered" id="form_table">
						<thead>
							<tr>
								<th class="text-center min-200">'.lang('pko').'</th>
								<th class="text-center min-200">'.lang('skala_program').'</th>
								<th class="text-center min-200">'.lang('target_financial').'</th>
								<th class="text-center min-200">'.lang('tujuan').'</th>
								<th class="text-center min-200">'.lang('output').'</th>
