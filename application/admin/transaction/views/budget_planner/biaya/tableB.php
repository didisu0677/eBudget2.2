...
foreach ($coa as $k => $v) {
		...
		foreach ($detail['1'][$v->glwnco] as $k2 => $v2) {
				...
				foreach ($detail['2'][$v2->glwnco] as $k3 => $v3) {
					...
					if(isset($detail['3'][$v3->glwnco])){
						foreach ($detail['3'][$v3->glwnco] as $k4 => $v4) {
								...
								foreach ($detail['4'][$v4->glwnco] as $k5 => $v5) {
									...
									if(isset($detail['5'][$v5->glwnco])){
										foreach ($detail['5'][$v5->glwnco] as $k6 => $v6) {
											...
											$item6 .= '<td><div style="min-height: 10px; width: 100%; overflow: hidden;" '.$edit.' class="edit-value text-right edit-bulan edited" data-name="biaya_bulan" data-id="'.$v6->glwnco.'" data-value="'.$valueTxt.'">'.$valueTxt.'</div></td>';
											$item6 .= '<td><div style="min-height: 10px; width: 100%; overflow: hidden;" contenteditable="false" class="edit-value text-right edited" data-name="biaya_tahun" data-id="'.$v6->glwnco.'" data-value="'.$bln_trakhir.'">'.$bln_trakhir.'</div></td>';
									...
									$item5 .= '<td><div style="min-height: 10px; width: 100%; overflow: hidden;" '.$edit.' class="edit-value text-right edit-bulan edited" data-name="biaya_bulan" data-id="'.$v6->glwnco.'" data-value="'.$valueTxt.'">'.check_data($valueTxt,0).'</div></td>';
									$item5 .= '<td><div style="min-height: 10px; width: 100%; overflow: hidden;" contenteditable="false" class="edit-value text-right edited" data-name="biaya_tahun" data-id="'.$v6->glwnco.'" data-value="'.$bln_trakhir.'">'.check_data($bln_trakhir,0).'</div></td>';
									$item5 .= '</tr>';
									$item5 .= $item6;
								}
								$bln_trakhir = '';
							...
							$item4 .= '<td><div style="min-height: 10px; width: 100%; overflow: hidden;" '.$edit.' class="edit-value text-right edit-bulan edited" data-name="biaya_bulan" data-id="'.$v4->glwnco.'" data-value="'.check_data($valueTxt,$minus4).'">'.$valueTxt.'</div></td>';
							$item4 .= '<td><div style="min-height: 10px; width: 100%; overflow: hidden;" contenteditable="false" class="edit-value text-right edited" data-name="biaya_tahun" data-id="'.$v4->glwnco.'" data-value="'.check_data($bln_trakhir,$minus4).'">'.$bln_trakhir.'</div></td>';
							$item4 .= '<td'.$bd.'></td>';
					...
					$item3 .= '<td><div style="min-height: 10px; width: 100%; overflow: hidden;" '.$editBulan3.' class="edit-value edit-bulan text-right edited" data-name="biaya_bulan" data-id="'.$v3->glwnco.'" data-value="'.$valueTxt.'">'.check_data($valueTxt,$minus3).'</div></td>';
					$item3 .= '<td><div style="min-height: 10px; width: 100%; overflow: hidden;" contenteditable="false" class="edit-value text-right edited" data-name="biaya_tahun" data-id="'.$v3->glwnco.'" data-value="'.$biaya_tahun3.'">'.check_data($biaya_tahun3,$minus3).'</div></td>';
					$item3 .= '<td'.$bd.'></td>';
			...
			for ($i=1; $i <=12 ; $i++) { 
				...
				if(count($dt3)>0){ 
					...
					$item2 .= '<td dt-d="'.$v2->{'bulan'.$i}.'"><div style="min-height: 10px; width: 100%; overflow: hidden;" '.$edit.' class="edit-value text-right edited" data-name="bulan_b'.$i.'" data-id="'.$v2->glwnco.'" data-value="'.$val.'">'.check_data($val,$minus2).'</div></td>'; 
					$dataSaved['bulan_b'.$i] = $val;
				}
				$biaya_tahun2 += $val;
			...
			$item2 .= '<td><div style="min-height: 10px; width: 100%; overflow: hidden;"bulan2 '.$editBulan2.' class="edit-value edit-bulan text-right edited" data-name="biaya_bulan" data-id="'.$v2->glwnco.'" data-value="'.$valueTxt.'">'.check_data($valueTxt,$minus2).'</div></td>';
			$item2 .= '<td><div style="min-height: 10px; width: 100%; overflow: hidden;" contenteditable="false" class="edit-value text-right edited" data-name="biaya_tahun" data-id="'.$v2->glwnco.'" data-value="'.$biaya_tahun2.'">'.check_data($biaya_tahun2,$minus2).'</div></td>';
			$item2 .= '<td'.$bd.'></td>';
	...
	$item .= '<td><div style="min-height: 10px; width: 100%; overflow: hidden;" contenteditable="false" class="edit-value text-right edited" data-name="biaya_tahun" data-id="'.$v->glwnco.'" data-value="'.$biaya_tahun1.'">'.check_data($biaya_tahun1,$minus).'</div></td>';
	$item .= '<td'.$bd.'></td>';
