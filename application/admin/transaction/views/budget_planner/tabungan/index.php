...
<?php $this->load->view($path.'sub_menu'); ?>
							...
							thead();
								...
								<tr>
									...
									foreach ($detail_tahun as $d) {
										...
										echo '<th rowspan="2" class="text-center" style="min-width:80px;vertical-align : middle;text-align:center;">Prosentase</th>';
									?>
								</tr>
								<tr>
									<?php
							...
							thead();
								...
								<tr>
									...
									foreach ($detail_tahun as $d) {
										...
										echo '<th class="text-center" rowspan="2" class="border-none"</th>';
										echo '<th class="text-center" rowspan="2" style="min-width:80px;vertical-align : middle;text-align:center;">Jumlah Terakhir</th>';
	...
	<div class="main-container d-rekening-content">
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
					<div class="card-header"><?php echo 'Jumlah Segmen Rekening'; ?></div>
	    			<div class="card-body">
